...
def basin_tmask(ocean):
    ...
    """
    land_mask = xr.open_dataset('./DATA/grids/regionmask_v6.nc')
...
def basin_mask_ht_full(basin, check=False):
    ...
    path = './DATA/FAFANTWATER_ideal_runoff_Boeira_rest_ice_0.0Sv/pp/'
    ...
    if check is True: 
       ...
       ax.plot([-69, -69], [-80,-34],      'b', linewidth = 1) #south america 
       ax.plot([-69, -69], [-34, 9],       'b', linewidth = 3) #south america 
       ax.plot([-53, -53], [-80,-34],      'g', linewidth = 3) #south america 
       ...
       ax.plot([-69, -69], [51, 90],       'b', linewidth = 3) #canada
       ax.plot([20, 20], [-80,31],       'b', linewidth = 3)   #africa
       ax.plot([-6, -6], [32,41],       'b', linewidth = 3)    #spain 
       ax.plot([0, 0], [42,50],         'b', linewidth = 3)    #uk 
       ax.plot([11, 11], [51,64],         'b', linewidth = 3)  #scandinavia 1 
       ax.plot([18, 18], [65,68],         'b', linewidth = 3)  #scandinavia 2 
       ax.plot([79, 79], [51, 90],       'b', linewidth = 3)   #asia
    ...
    if basin=='Pacific':
       ...
       atl_map1 = (land_mask.where(land_mask.yt_ocean < 9).where(land_mask.yt_ocean > -34).where(land_mask.xt_ocean > -69).where(land_mask.xt_ocean < 20)).fillna(0)
       atl_map11 = (land_mask.where(land_mask.yt_ocean < -34).where(land_mask.yt_ocean > -90).where(land_mask.xt_ocean > -53).where(land_mask.xt_ocean < 20)).fillna(0)
       atl_map2 = (land_mask.where(land_mask.yt_ocean > 9).where(land_mask.yt_ocean < 15.5).where(land_mask.xt_ocean > -83.7).where(land_mask.xt_ocean < 20)).fillna(0)
       atl_map3 = (land_mask.where(land_mask.yt_ocean > 15.5).where(land_mask.yt_ocean < 17).where(land_mask.xt_ocean > -93.3).where(land_mask.xt_ocean < 20)).fillna(0)
       atl_map4 = (land_mask.where(land_mask.yt_ocean > 17).where(land_mask.yt_ocean < 31).where(land_mask.xt_ocean > -99).where(land_mask.xt_ocean < 20)).fillna(0)
       atl_map5 = (land_mask.where(land_mask.yt_ocean > 31).where(land_mask.yt_ocean < 41).where(land_mask.xt_ocean > -99).where(land_mask.xt_ocean < -6)).fillna(0)
       atl_map6 = (land_mask.where(land_mask.yt_ocean > 41).where(land_mask.yt_ocean < 50).where(land_mask.xt_ocean > -99).where(land_mask.xt_ocean < 0)).fillna(0)
       atl_map7 = (land_mask.where(land_mask.yt_ocean > 50).where(land_mask.yt_ocean < 64).where(land_mask.xt_ocean > -69).where(land_mask.xt_ocean < 11)).fillna(0)
       atl_map8 = (land_mask.where(land_mask.yt_ocean > 64).where(land_mask.yt_ocean < 68).where(land_mask.xt_ocean > -69).where(land_mask.xt_ocean < 18)).fillna(0)
       atl_map9 = (land_mask.where(land_mask.yt_ocean > 68).where(land_mask.yt_ocean < 90).where(land_mask.xt_ocean > -69).where(land_mask.xt_ocean < 79)).fillna(0)
       atl_sector_map = atl_map1 + atl_map11 + atl_map2 + atl_map3 + atl_map4 + atl_map5 + atl_map6 + atl_map7 + atl_map8 + atl_map9
       mask = atl_sector_map.where(atl_sector_map>0)
    elif basin=='Indian':
       ind_map1 = (land_mask.where(land_mask.yt_ocean < 31).where(land_mask.yt_ocean > -90).where(land_mask.xt_ocean > 20).where(land_mask.xt_ocean < 79)).fillna(0)
...
def basin_mask_ht(basin, SO=False, check=False):
